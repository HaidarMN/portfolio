<template>
    <div class="bg-[#A3A9B0] text-[#EBEDEC] h-fit px-[50px] sm:px-[75px] lg:px-[150px] pt-[50px] sm:pt-[100px] lg:pt-[150px] pb-[50px] sm:pb-[75px] lg:pb-[100px] flex flex-col justify-center gap-2 sm:gap-4">
        <h1 class="text-xl sm:text-3xl lg:text-5xl text-center font-extrabold hid">About Me</h1>
        <div class="flex flex-col-reverse sm:flex-row items-center sm:justify-between w-full mt-2 sm:mt-4 lg:mt-8 gap-4 md:gap-0">
            <div class="flex flex-col sm:w-1/2 gap-2 sm:gap-4 hid">
            ...
            <div class="flex justify-center sm:w-1/2 hid">
